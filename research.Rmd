...
<p align="justify">Artificial intelligence (deep learning/machine learning), bayesian analytics and human-computer interaction focused on medical device as well as aviation systems safety including big data analysis & visualisation: human error, empirical studies, perceptual interference, disfluencey, cognitive theory, augmented reality, probabilistic timing analysis, software modeling, autonomous systems, robotics, unmanned-areal vehicle control systems, flight-deck system safety, cyber-security, forensics</p>
